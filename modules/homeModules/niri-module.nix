    ...
    { pkgs, ... }:
    {
      wayland.windowManager.niri = {
        ...
        settings = {
          ...
          "recent-windows".binds."Mod+Tab"."next-window"._props.scope = "workspace";
          ...
          binds = {
            ...
            "Mod+E" = {
              _props."hotkey-overlay-title" = "Open file manager: yazi";
              spawn = [
                "sh"
                "-c"
                "kitty -e yazi"
            ...
            "Mod+N" = {
              _props."hotkey-overlay-title" = "Open notes";
              spawn = [ "launch-notes" ];
            };
            "Mod+Shift+M" = {
              _props."hotkey-overlay-title" = "Toggle music player: rmpc";
              spawn = [ "launch-rmpc" ];
            };
            "Mod+Shift+Insert" = {
              _props."hotkey-overlay-title" = "Open password picker: television";
              spawn = [
                "kitty"
                "--class"
                "tv-pass"
            ...
            "Mod+A"."focus-workspace" = "stash";
            "Mod+S"."focus-workspace" = "stash";
            ...
            "Mod+Shift+A"."move-column-to-workspace" = "stash";
            "Mod+Shift+S"."move-column-to-workspace" = "stash";
          ...
          _children = [
            ...
            {
              "window-rule" = {
                match._props."app-id" = "^neovide-notes$";
